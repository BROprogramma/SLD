...
De door het bevoegd gezag vastgestelde gevallen van ernstige verontreiniging (onder het regime van de Wbb) en de door het bevoegd gezag opgelegde nazorg na een sanering hebben ook een registratieplicht in de openbare registers op grond van de Wkpb, en worden als publiekrechtelijke beperking in de Basisregistratie Kadaster-Publiekrechtelijke beperkingen (BRK-PB) geregistreerd. De in de catalogus opgenomen gebruiksbeperkingen (zie tabel [7.5 Gebruiksbeperking](#detail_class_Model_Gebruiksbeperking)) gelden als een nadere detaillering van deze publiekrechtelijke beperkingen bij nazorgmaatregelen in de vorm van gestructureerde data. In tegenstelling tot de openbare registers staan in het BRO-register van SLD geen documenten zoals besluiten, meldingen en bescheiden inzake bodemverontreiniging, maar gestructureerde, inhoudelijke gegevens uit deze documenten. De gegevens kunnen dan conform één standaard via één landelijke online ingang, de BRO, rechtstreeks en op elk tijdstip worden hergebruikt in de applicaties van initiatiefnemers van activiteiten op of in de bodem.
...
Deze entiteit bevat de gegevens die het registratieobject identificeren en inzicht geven in de totstandkoming en context van het object voorafgaand aan opname in de registratie ondergrond. Kader aanlevering is daarbij bepalend voor de inhoud van de registratie van de gegevens onder het regime van Wbb, danwel Ow. Deze entiteit bevat twee gegevensgroepen; de _Registratiegeschiedenis_ (BRO generiek) en de _Gestandaardiseerde locatie_ (BRO generiek). Zoals aangegeven in de inleiding kunnen gegevens zijn ontstaan onder twee verschillende wettelijke regimes: Wbb of Ow. Registraties die ontstaan zijn onder het regime van de Wbb (ongeacht of de aanpak is afgerond of dat sprake is van overgangsrecht) worden als Bodemlocatie opgenomen. Registraties die zijn ontstaan onder het regime van de Ow worden vastgelegd als Aangepakt gebied.
...
## Besluit
Deze entiteit wordt alleen vastgelegd bij gegevens die zijn aangeleverd onder het regime van de Wbb, en bevat de gegevens van de processtappen zoals door het bevoegd gezag zijn vastgelegd bij de beoordeling en aanpak van bodemverontreiniging. Dit zijn doorgaans besluiten die zijn genomen in het kader van de Wbb over de vaststelling en de aanpak van de bodemverontreiniging. Deze entiteit bevat de gegevens die het besluit of andere processtappen identificeren (unieke SIKB0101-identificatie en kenmerk) en inzicht geven in het besluittype en de datum waarop het besluit bekend is gemaakt.

De term 'besluit' wordt binnen BRO-SLD breder geïnterpreteerd dan in de Algemene wet bestuursrecht (artikel 1:3). Onder de term ‘besluittype’ zijn hierdoor ook categorieën gegevens opgenomen die geen besluit in de context van de Algemene wet bestuursrecht betreffen. Voor een toelichting op de term ‘Overheidsbesluit bodemverontreiniging’ wordt verwezen naar paragraaf 4.1.
...
## Nazorggebied
Deze entiteit wordt alleen vastgelegd bij gegevens die zijn aangeleverd onder het regime van de Wbb, en bevat de gegevens van de vastgestelde nazorg en eventuele gebruiksbeperkingen die na afloop van de sanering zijn opgelegd. Naast identificerende kenmerken (SIKB0101-identificatie en contour) is het mogelijk aan te geven hoe lang de nazorg van toepassing is en op welke datum deze in werking is getreden. In de bijbehorende nazorgmaatregel kan worden gespecificeerd welke gebruiksbeperking is opgelegd.

Op dit punt volgt de BRO de wijze van vastlegging in het BIS door gebruiksbeperkingen te registreren onder een nazorgcontour.
